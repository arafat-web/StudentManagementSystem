...
public final class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        totalDeptData = new javax.swing.JLabel();
        jPanel8 = new javax.swing.JPanel();
        jPanel9 = new javax.swing.JPanel();
        jLabel7 = new javax.swing.JLabel();
        totalSessionData = new javax.swing.JLabel();
        ...
        totalDeptData.setFont(new java.awt.Font("Bookman Old Style", 1, 24)); // NOI18N
        totalDeptData.setForeground(new java.awt.Color(255, 255, 255));
        totalDeptData.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        totalDeptData.setText("1000");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addComponent(totalDeptData, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(totalDeptData, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        totalSessionData.setFont(new java.awt.Font("Bookman Old Style", 1, 24)); // NOI18N
        totalSessionData.setForeground(new java.awt.Color(255, 255, 255));
        totalSessionData.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        totalSessionData.setText("1000");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addComponent(totalSessionData, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(totalSessionData, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(15, Short.MAX_VALUE))
        );
        ...
        listTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Phone", "Session", "Department", "Date of Birth", "Gender", "Address"
            }
        ) {
    ...
    private javax.swing.JLabel totalDeptData;
    private javax.swing.JLabel totalSessionData;
    ...
    public void updateSession() throws SQLException {
        ...
        Connection conn = DatabaseConnection.ConnectDb();
        String url = "SELECT COUNT(id) FROM sessiondata;";
        ...
        try {
            ...
            totalSessionData.setText(Integer.toString(totalSession));
        } catch (SQLException ex) {
            System.out.println(ex);
        }
    ...
    private void updateDept() throws SQLException {
        Connection conn = DatabaseConnection.ConnectDb();
        String url = "SELECT COUNT(id) FROM deptdata;";
        ...
        try {
            ...
            while (rs.next()) {
                totalDept = rs.getInt(1);

            }
            totalDeptData.setText(Integer.toString(totalDept));
        } catch (SQLException ex) {
            System.out.println(ex);
        }
    }
    ...
    public void updateTable() throws SQLException {
        ...
        Connection conn = DatabaseConnection.ConnectDb();
        String url = "Select id, name, phone, session, dept, dob, gender, address from studentsdata ORDER BY id DESC";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                colData[2] = rs.getString("session");
                colData[3] = rs.getString("dept");
                colData[4] = rs.getString("dob");
                colData[5] = rs.getString("gender");
                colData[6] = rs.getString("address");
