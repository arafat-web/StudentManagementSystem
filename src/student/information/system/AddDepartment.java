...
public class AddDepartment extends javax.swing.JFrame {
    ...
    public AddDepartment() {
        ...
        holder = new PlaceHolder(search, Color.LIGHT_GRAY, Color.black, "Ex: Computer Science & Engineering", false, "TOHOMA", 15);
         holder = new PlaceHolder(name, Color.LIGHT_GRAY, Color.black, "Ex: Computer Science & Engineering", false, "TOHOMA", 15);
    }
    ...
    private void eventSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eventSaveActionPerformed
        try {
            ...
            updateTable();
            if (name.getText().equals("Ex: Computer Science & Engineering")) {
                PopUp popUp = new PopUp();
                popUp.setVisible(true);
                popUp.setHeader.setText("Error!");
                popUp.setHeader.setForeground(Color.red);
                popUp.setMsg.setText("Please fill department box.");
            } else {
                try {
                    String sql = "INSERT into deptdata (name) values (?)";
                ...
                popUp.setMsg.setText("Department saved successfully.");
                name.setText("");
                holder = new PlaceHolder(name, Color.LIGHT_GRAY, Color.black, "Ex: Computer Science & Engineering", false, "TOHOMA", 15);
                updateTable();
            }
    ...
    // End of variables declaration//GEN-END:variables
        ...
        String url = "Select id, name from deptdata";
    ...
    public void searchStudent() throws SQLException {
        ...
        if (search.getText().equals("")) {
            ...
            ps = con.prepareStatement("SELECT * FROM `deptdata` WHERE  `name` LIKE '%"+search.getText()+"%'");
        ...
        if (infoTable.getSelectedRow() == -1) {
            ...
            String sql = "delete from deptdata where id='" + getID + "'";
            try {
